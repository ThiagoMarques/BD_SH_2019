        ...
        <div class="card-body">
            <div class="col-sm-8">
                <fieldset>
                    ...
                    <form method="POST" action="../config/insert_pres.php">
                        <input type="hidden" name="id" value="<?=$linha['ID_Con']?>" required>
                        <div class="form-group">
                            <label for="medico">Médico Responsável</label>
                            <input disabled type="text" class="form-control" name="medico" id="medico"
                            value="<?=$linha['Nome_Med']?>" required>
                        </div>
                        <div class="form-group">
                            <label for="medico">Paciente</label>
                            <input disabled type="text" class="form-control" name="paciente" id="paciente"
                        ...
                        <button type="submit" value="Cadastrar" class="btn btn-primary btn-lg btn-block">Editar Consulta</button>
                    </form>
                </fieldset>
                <hr>
