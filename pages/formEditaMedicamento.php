        ...
        <div class="card-body">
            <div class="col-sm-8">
                <fieldset>
                    ...
                    <form method="POST" action="../config/updateMedicamento.php">
                        <input type="hidden" name="id" value="<?=$linha['ID_Medicamento']?>" required>
                        <div class="form-group">
                            <label for="nome_medicamento">Nome do Medicamento</label>
                            <input type="text" class="form-control" name="nome_medicamento" id="nome_medicamento" value="<?=$linha['Nome_Prod']?>">
                        </div>
                        <div class="form-group">
                            <label for="marca_medicamento">Marca do Medicamento</label>
                            <input type="text" class="form-control" name="marca_medicamento" id="marca_medicamento" value="<?=$linha['Marca_Prod']?>">
                        </div>
                        <div>
                            <div class="form-group">
                                <label for="validade">Data de Validade</label>
                                <input type="date" class="form-control" name="validade" value="<?=$linha['Validade']?>">
                            </div>
                        </div>
