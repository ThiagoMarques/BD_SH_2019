    ...
    <div class="card">
        <div class="col-sm8">
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">Nome Médico</td>
                        <th scope="col">Nome Paciente</td>
                ...
                <tbody>
                    ...
                    <?php
                                ...
                                $query = "SELECT * FROM prescricao order by ID_Pres DESC";
                    ...
                    <tr>
                        ...
                        <td><?= $linha['Nome_Medicamento'] ?></td>
                        <td><?= $linha['Descricao'] ?></td>
                        <td>
                            <a href="../config/delete_pres.php?id=<?=$linha['ID_Pres']?>">
                                <button class="btn btn-info"
                                    onclick="return confirm('Confirmar exclusão do registro?')">Excluir</button></a>

                            <a href="formEditaPres.php?id=<?=$linha['ID_Pres']?>">
